var app = angular.module('leangainsApp', ['ngRoute','rzModule'])
...
.config(function($routeProvider, $locationProvider) {
    $routeProvider
        ...
        .when('/macro_calculator/', {
	        	templateUrl: 'partials/macro_calculator.html',
...
.controller('calculatorController', ['$scope', function($scope) {
	...
	$scope.switchInputMethod = function() {
		if ($scope.usingMetric) {
			$scope.usingMetric = false;
		}
		else {
			$scope.usingMetric = true;
		}
		return $scope.usingMetric;
	}
